...
SECRET_KEY = 'django-insecure-z!#-i&henk9tbev#f-oiu#z8ta76b(r3d(dh^4inbvsm8h$2i0'
...
# For enabling MySQL database connection
DATABASES = {
    'default': {
...
# For enabling sqlite database connection
# DATABASES = {
#     'default': {
